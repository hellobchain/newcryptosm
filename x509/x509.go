...
func marshalPublicKey(pub interface{}) (publicKeyBytes []byte, publicKeyAlgorithm pkix.AlgorithmIdentifier, err error) {
	...
	case *ecdsa.PublicKey:
		...
		oidPublicKey, _ := oidPublicKeyFromNamedCurve(pub.Curve)
		publicKeyAlgorithm.Algorithm = oidPublicKey
		var paramBytes []byte
	...
	default:
		return nil, pkix.AlgorithmIdentifier{}, errors.New("x509: only RSA and ECDSASM2 public keys supported")
	}
...
var signatureAlgorithmDetails = []struct {
	...
	{MD2WithRSA, "MD2-RSA", oidSignatureMD2WithRSA, RSA, newcryptosm.Hash(0) /* no value for MD2 */},
	{MD5WithRSA, "MD5-RSA", oidSignatureMD5WithRSA, RSA, newcryptosm.MD5},
	{SHA1WithRSA, "SHA1-RSA", oidSignatureSHA1WithRSA, RSA, newcryptosm.SHA1},
	{SHA1WithRSA, "SHA1-RSA", oidISOSignatureSHA1WithRSA, RSA, newcryptosm.SHA1},
	{SHA256WithRSA, "SHA256-RSA", oidSignatureSHA256WithRSA, RSA, newcryptosm.SHA256},
	{SHA384WithRSA, "SHA384-RSA", oidSignatureSHA384WithRSA, RSA, newcryptosm.SHA384},
	{SHA512WithRSA, "SHA512-RSA", oidSignatureSHA512WithRSA, RSA, newcryptosm.SHA512},
	{SHA256WithRSAPSS, "SHA256-RSAPSS", oidSignatureRSAPSS, RSA, newcryptosm.SHA256},
	{SHA384WithRSAPSS, "SHA384-RSAPSS", oidSignatureRSAPSS, RSA, newcryptosm.SHA384},
	{SHA512WithRSAPSS, "SHA512-RSAPSS", oidSignatureRSAPSS, RSA, newcryptosm.SHA512},
	{DSAWithSHA1, "DSA-SHA1", oidSignatureDSAWithSHA1, DSA, newcryptosm.SHA1},
	{DSAWithSHA256, "DSA-SHA256", oidSignatureDSAWithSHA256, DSA, newcryptosm.SHA256},
	{ECDSAWithSHA1, "ECDSA-SHA1", oidSignatureECDSAWithSHA1, ECDSA, newcryptosm.SHA1},
	{ECDSAWithSHA256, "ECDSA-SHA256", oidSignatureECDSAWithSHA256, ECDSA, newcryptosm.SHA256},
	{ECDSAWithSHA384, "ECDSA-SHA384", oidSignatureECDSAWithSHA384, ECDSA, newcryptosm.SHA384},
	{ECDSAWithSHA512, "ECDSA-SHA512", oidSignatureECDSAWithSHA512, ECDSA, newcryptosm.SHA512},
	{SM2WithSM3, "SM2-SM3", oidSignatureSM2WithSM3, SM2, newcryptosm.SM3},
	{SM2WithSHA1, "SM2-SHA1", oidSignatureSM2WithSHA1, SM2, newcryptosm.SHA1},
	{SM2WithSHA256, "SM2-SHA256", oidSignatureSM2WithSHA256, SM2, newcryptosm.SHA256},
}
...
func checkSignature(algo SignatureAlgorithm, signed, signature []byte, publicKey crypto.PublicKey) (err error) {
	...
	switch hashType {
	case newcryptosm.Hash(0):
		return ErrUnsupportedAlgorithm
	case newcryptosm.MD5:
	...
	case *ecdsa.PublicKey:
		...
		if rest, err := asn1.Unmarshal(signature, ecdsaSig); err != nil {
			...
			return errors.New("x509: trailing data after ECDSA SM2 signature")
		}
...
// signature algorithm.
func signingParamsForPublicKey(pub interface{}, requestedSigAlgo SignatureAlgorithm) (hashFunc newcryptosm.Hash, sigAlgo pkix.AlgorithmIdentifier, err error) {
