...
func X509KeyPair(certPEMBlock, keyPEMBlock []byte) (Certificate, error) {
	...
	case *ecdsa.PublicKey:
		...
		if !ok {
			return fail(errors.New("tls: ecdsa sm2 private key type does not match public key type"))
		}
		if pub.X.Cmp(priv.X) != 0 || pub.Y.Cmp(priv.Y) != 0 {
			return fail(errors.New("tls: ecdsa sm2 private key does not match public key"))
		}
	default:
