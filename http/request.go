...
func (r *Request) write(w io.Writer, usingProxy bool, extraHeaders Header, waitForContinue func() bool) (err error) {
	...
	if stringContainsCTLByte(ruri) {
		return errors.New("github.com/hyperledger/fabric-sdk-go/third_party/github.com/hyperledger/fabric/smalgo/gmhttp: can't write control character in Request.URL")
	}
...
func NewRequestWithContext(ctx context.Context, method, url string, body io.Reader) (*Request, error) {
	...
	if !validMethod(method) {
		return nil, fmt.Errorf("github.com/hyperledger/fabric-sdk-go/third_party/github.com/hyperledger/fabric/smalgo/gmhttp: invalid method %q", method)
	}
	if ctx == nil {
		return nil, errors.New("github.com/hyperledger/fabric-sdk-go/third_party/github.com/hyperledger/fabric/smalgo/gmhttp: nil Context")
	}
...
// only supports HTTP/1.x requests. For HTTP/2, use golang.org/x/net/http.
