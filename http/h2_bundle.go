...
//
// See https://http.github.io/ for more information on HTTP/2.
//
// See https://http.golang.org/ for a test server running this code.
//
...
// noDialClientConnPool is an implementation of http.ClientConnPool
...
// http://http.github.io/http2-spec/#rfc.section.11.2
...
//
// See http://http.github.io/http2-spec/#FrameHeader
...
// See http://http.github.io/http2-spec/#rfc.section.6.1
...
// behavior.
//
// See http://http.github.io/http2-spec/#SETTINGS
...
// is still functional.
// See http://http.github.io/http2-spec/#rfc.section.6.7
...
// See http://http.github.io/http2-spec/#rfc.section.6.8
...
// See http://http.github.io/http2-spec/#rfc.section.6.9
...
// See http://http.github.io/http2-spec/#rfc.section.6.3
...
// See http://http.github.io/http2-spec/#rfc.section.6.4
...
// See http://http.github.io/http2-spec/#rfc.section.6.10
...
// See http://http.github.io/http2-spec/#rfc.section.6.6
...
const (
	...
	// http://http.github.io/http2-spec/#rfc.section.6.5.2
	...
	// http://http.github.io/http2-spec/#SettingValues
...
type http2Setting struct {
	...
	// See http://http.github.io/http2-spec/#SettingValues
	ID http2SettingID
...
// http://http.github.io/http2-spec/#iana-settings
...
// from a user's x/net/http. As such, as it has a unique method name
...
var http2errRequestCanceled = errors.New("github.com/hyperledger/fabric-sdk-go/third_party/github.com/hyperledger/fabric/smalgo/gmhttp: request canceled")
...
func (cc *http2ClientConn) responseHeaderTimeout() time.Duration {
	...
	// No way to do this (yet?) with just an http.Transport. Probably
	// no need. Request.Cancel this is the new way. We only need to support
	// this for compatibility with the old http.Transport fields when
	// we're doing transparent http.
	return 0
}
...
// shouldSendReqContentLength reports whether the http.Transport should send
...
func (b http2transportResponseBody) Read(p []byte) (n int, err error) {
	...
	if cs.bytesRemain != -1 {
		if int64(n) > cs.bytesRemain {
			...
			if err == nil {
				err = errors.New("github.com/hyperledger/fabric-sdk-go/third_party/github.com/hyperledger/fabric/smalgo/gmhttp: server replied with more than declared Content-Length; truncated")
